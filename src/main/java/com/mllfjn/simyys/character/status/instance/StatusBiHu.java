...
public class StatusBiHu extends Status {
    ...
    public StatusBiHu(Character from, Character belongTo) {
        ...
        super(StatusName, from, belongTo, StatusType.SPECIAL, StatusForm.YIN_JI);
        runOn(Trigger.ADDING_CROWD_CONTROL, param -> {
            EffectInfo effectInfo = ((ParamAddCrowdControl) param).getEffectInfo();
