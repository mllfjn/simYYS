...
public class StateChenLun extends State implements CrowdControl, InfluenceDamage, Displayable {
    ...
    public boolean effective(AttackType attackType, Character character) {
        ...
        // TODO 自身回合内
        return character == from || character.isHaveState(StateHuiMie.class);
    }
