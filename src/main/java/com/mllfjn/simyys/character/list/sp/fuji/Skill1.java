...
class Skill1 extends Skill1PuGongBase {
    public static final String SkillName = "缠心";
    private static final int[] multiplier = {0, 70, 80, 90, 100, 100};

    private final int defensePerStack;

    public Skill1(Character belongTo, int level, int defensePerStack) {
    ...
    public String getSkillDesc() {
        return """
                ...
                √\tlv3-伤害增加至90%
                √\tlv4-伤害增加至100%
                \tlv5-每次攻击时,改为对目标附加持续5回合的5级中毒
                √\t\t和持续至战斗结束的50点减防(上限500点)
                """;
    }
    ...
    public void usePrivate(Interactive interactive, Character target) {
        ...
        StatusFJReduceDefense.addStack(getBelongTo(), target, defensePerStack);
    }
